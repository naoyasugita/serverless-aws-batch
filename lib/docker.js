...
function buildDockerImage() {
    ...
    if (this.serverless.service.provider.runtime === "python3.6" || this.serverless.service.provider.runtime === "python3.9") {
    ...
    FROM mlupin/docker-lambda:${this.serverless.service.provider.runtime}-build AS builder
    USER root
    ...
    FROM mlupin/docker-lambda:${this.serverless.service.provider.runtime}
    ...
    this.serverless.cli.log(dockerFileContents);
